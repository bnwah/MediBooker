...
const MyAppointments = () => {
  ...
  {/* Will use doctors data as placeholder for this pg 
  (which supposed to list appmts) until we get backend running  */}
        ...
        <div>
          {doctors.slice(0, 3).map((item, index) => (
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div></div> {/* Div for spacing. It appears to the left of the buttons */}
